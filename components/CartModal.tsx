    ...
    <>
      ...
      >
        <div className="flex h-full flex-col bg-white shadow-xl">
          ...
          {items.length > 0 && (
            <div className="border-t border-stone-200/70 px-6 py-4">
              ...
              <Link
                href="/cart"
                onClick={closeCart}
                className="block w-full rounded-lg bg-amber-600 py-3 text-center font-bold text-white shadow-md transition hover:bg-amber-700 hover:shadow-lg mb-2"
              >
                View Cart
              </Link>
              ...
              <button
                ...
                className="w-full rounded-lg border border-red-300 py-2 text-sm font-semibold text-red-600 transition hover:bg-red-50"
              >
                Clear Cart
              </button>
            </div>
